...
public class debitAccount {
    ...
    static SecretKey testing() throws Exception {
        ...
        jsonObject.put("amount", "53.00");
        jsonObject.put("fee", "10.75");
        jsonObject.put("srcAccount", "4021028069");
        jsonObject.put("description", "airtime");
        jsonObject.put("requestId", "01233444507241001900");
