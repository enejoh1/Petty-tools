...
public class AccountCreationTestHTTP {
    ...
    static SecretKey testing() throws Exception {
        ...
        jsonObject.put("firstName", "Enejoh");
        jsonObject.put("requestId", "03516192329962918291");
        jsonObject.put("lastName", "Abu");
        jsonObject.put("dob", "1989-08-14");
        jsonObject.put("msisdn", "+2349157694198");
        jsonObject.put("token", "1234");
        jsonObject.put("gender", "M");
        jsonObject.put("email", "chrisenejohabu@gmail.com");
        jsonObject.put("address", "No.16, Aaretedo Street, New bodija, Ibadan North, Oyo.");
        jsonObject.put("bankCode", "555");
        jsonObject.put("bvn", "22145862752");
        jsonObject.put("address", "No.16, Aaretedo Street, New bodija, Ibadan North, Oyo.");
        jsonObject.put("pin", "0000");
        jsonObject.put("verifyPin", "0000");
        jsonObject.put("terminalId", "2024071918501Opop");
        jsonObject.put("referalCodeParent", "00000");
        jsonObject.put("referalCodeChild", "Enab07");
        jsonObject.put("password", "vaka@23A");
        jsonObject.put("verifyPassword", "vaka@23A");
        jsonObject.put("msisdnSecureCode", "234089145848229822990");

//
//        jsonObject.put("firstName", "Webster");
//        jsonObject.put("requestId", "19626136416232021985");
//        jsonObject.put("lastName", "John");
//        jsonObject.put("dob", "2023-06-06");
//        jsonObject.put("msisdn", "+2348107742127");
//        jsonObject.put("token", "1234");
//        jsonObject.put("gender", "m");
//        jsonObject.put("email", "johnwebster221@gmail.com");
//        jsonObject.put("address", "9, Egbeda, Lagos");
//        jsonObject.put("bankCode", "555");
//        jsonObject.put("bvn", "21565907991");
//        jsonObject.put("address", "I viral boulevard, eko atlantic citzy lagos");
//        jsonObject.put("pin", "1234");
//        jsonObject.put("verifyPin", "1234");
//        jsonObject.put("terminalId", "1234567890");
//        jsonObject.put("referalCodeParent", "Coopvest");
//        jsonObject.put("referalCodeChild", "joweb23");
//        jsonObject.put("password", "Vinotesting00@1");
//        jsonObject.put("verifyPassword", "Vinotesting00@1");
//        jsonObject.put("msisdnSecureCode", "123456789011111");
//
...
//            ////////////////
            ...
            Request request = new Request.Builder().url("http://216.172.103.62:8056/Viral-GateWay/api/do-account-opening").
                    method("POST", body).
