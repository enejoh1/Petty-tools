...
public class localTransfer {
    ...
    static SecretKey testing() throws Exception {
        ...
        jsonObject.put("requestId", "07218902017527992092");
        jsonObject.put("srcBankCode", "555");
        jsonObject.put("destBankCode", "555");
        jsonObject.put("amount", "44.00");
        jsonObject.put("fee", "11.00");
        jsonObject.put("description", "LoanChristmas");
        jsonObject.put("srcAccount", "4021027988");
        jsonObject.put("destAccount", "4021027952");
        jsonObject.put("token", "2");
...
//            ////////////////
            ...
            Request request = new Request.Builder().url("http://216.172.103.62:8056/Viral-GateWay/api/debit").
                    method("POST", body).
