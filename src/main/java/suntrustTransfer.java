...
public class suntrustTransfer {
    ...
    public static void main(String[] args) {
        System.out.println(new suntrustTransfer().sunTrustTransfer());
    }
    ...
    public String payLoadBody() {
        ...
        jsonObject.add("request_type", new JsonPrimitive("disburse"));
        ...
        transaction.add("amount", new JsonPrimitive(1000));
        ...
        details.add("destination_account", new JsonPrimitive("8067242034"));
        details.add("destination_bank_code", new JsonPrimitive("305"));
    ...
    public String sunTrustTransfer() {
        try {
