...
public class sunTrustValidateAccount {
    ...
    public static void main(String[] args) {
        System.out.println(new sunTrustValidateAccount().sunTrustValidate());
    }
    ...
    public static String encryptV2(String data) {
        try {
            ...
            byte[] source = "FdgFNBjO1UGn9RHt".getBytes(StandardCharsets.UTF_16LE);
            MessageDigest md = MessageDigest.getInstance("MD5");
    ...
    public String payLoadBody() {
        ...
        String encryptedAccountNumber = encryptV2("0038288035");
        //22153225112
        JsonObject jsonObject = new JsonObject();
        jsonObject.add("request_ref", new JsonPrimitive(randomNumber));
        jsonObject.add("request_type", new JsonPrimitive("lookup_account_min"));

        JsonObject auth = new JsonObject();
        auth.add("type", new JsonPrimitive("bank.account"));
        auth.add("secure", new JsonPrimitive(encryptedAccountNumber));
        auth.addProperty("auth_provider", "SunTrust");
        ...
        jsonObject.add("details", JsonNull.INSTANCE);
    ...
    public String sunTrustValidate() {
        try {
